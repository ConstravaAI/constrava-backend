...
function cxPrivate(p){return p==="/app"||p==="/app/"||p.startsWith("/app/")||p==="/dashboard"||p.startsWith("/dashboard/")||p==="/crm"||p.startsWith("/crm/")||p==="/api/dashboard"||p==="/live"||p==="/reports/latest"||p==="/sites";}
