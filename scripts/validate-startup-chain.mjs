...
await assertContains("scripts/start-runtime.mjs", 'generatedSource.includes("migration-safety-runtime-v2")', "the migration-safe generated runtime check");
...
await assertContains("src/.server.generated.js", "migration-safety-runtime-v2", "the generated migration safety marker");
