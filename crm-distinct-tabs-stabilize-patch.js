...
if (source.includes('.cx-top-ai{display:flex;gap:8px;align-items:center;min-width:min(620px,48vw);max-width:720px;margin-left:auto}') && !source.includes('.cx-ai-helper')) {
  source = source.replace('.cx-top-ai{display:flex;gap:8px;align-items:center;min-width:min(620px,48vw);max-width:720px;margin-left:auto}', '.cx-top-ai{display:flex;gap:8px;align-items:center;min-width:min(720px,56vw);max-width:820px;margin-left:auto}.cx-ai-helper{color:#d1fae5;font-size:12px;font-weight:950;white-space:nowrap}.cx-ai-info{width:28px!important;height:28px!important;min-width:28px!important;border-radius:999px!important;padding:0!important;display:inline-grid!important;place-items:center!important;background:rgba(255,255,255,.1)!important;color:#d1fae5!important;border:1px solid rgba(209,250,229,.35)!important;font-weight:950!important;font-style:normal!important}.cx-ai-info:hover{background:rgba(16,185,129,.24)!important}');
  changed = true;
}
...
if (changed) {
  ...
  console.log("Distinct CRM top-bar AI helper label and info icon added.");
} else {
  console.log("Distinct CRM top-bar helper already applied or anchor not found.");
}
